...
<head>
    ...
    <link rel="stylesheet" media="screen"
        href="<c:url value="/resources/library-vendor/bootstrap/css/bootstrap.min.css" />" >
...
<body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <a href="https://github.com/romelgomez/jqtree-spring-mvc-gae-example"><img
                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li>jqTree <a href="http://mbraak.github.io/jqTree/">http://mbraak.github.io/jqTree/</a>
                                </li>
                                <li>Spring MVC <a
                                        href="http://projects.spring.io/spring-framework/">http://projects.spring.io/spring-framework/</a>
                                </li>
                                <li>Google App Engine API <a
                                        href="https://developers.google.com/appengine/docs/java/">https://developers.google.com/appengine/docs/java/</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="btn-toolbar" role="toolbar">
                                            <div id="admin-category" class="btn-group">
                                                <button id="edit-category" type="button"
                                                    class="btn btn-default disabled">Edit</button>
                                                <button id="delete-category" type="button"
                                                    class="btn btn-default disabled">Delete</button>
                                            </div>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-primary new-category">Add a new
                                                    category!</button>
                                            </div>
                                        </div>
                                        ...
                                        <strong>To edit or delete:</strong> Select the category and then select the
                                        action.
                    ...
                    <div id="no-tree" style="display:none;">
                        <div class="alert alert-info" role="alert">
                            <strong>Alerta!</strong> no categories loaded yet. <a class="new-category"
                                href="#"><strong>Add a new category!</strong></a>
                        </div>
                    </div>
                ...
                <form role="form" id="category-add-form" action="#" method="post" accept-charset="utf-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger alert-dismissible" style="display: none;" role="alert">
                            <button type="button" class="close" data-dismiss="alert"><span
                                    aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            An error has occurred, try again or you can also try reloading the page if the error
                            persists!
                        </div>

                        <div class="form-group">
                            <label for="category-name"><span class="glyphicon glyphicon-folder-close"></span>
                                Name</label>
                            <input type="text" class="form-control" id="category-name" name="category-name"
                                placeholder="Eje: Laptops">
            ...
            <div class="modal-content">
                <form role="form" id="category-edit-form" action="#" method="post" accept-charset="utf-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit-category-name"><span class="glyphicon glyphicon-folder-close"></span>
                                Nombre</label>
    ...
    <section>
        ...
        <!-- jQuery Validation -->
        <script src="<c:url value="/resources/library-vendor/jquery/validation/jquery.validate.min.js" />
        "  type="text/javascript" ></script>

        <!-- jQuery Validation Additional Methods -->
        <script src="<c:url value="/resources/library-vendor/jquery/validation/additional-methods.min.js" />
        "  type="text/javascript" ></script>

        <!-- Bootstrap -->
        <script src="<c:url value="/resources/library-vendor/bootstrap/js/bootstrap.min.js" />" type="text/javascript">
        </script>
        ...
        <script src="<c:url value="/resources/library-vendor/respond/respond.min.js" />" type="text/javascript">
        </script>
        <script src="<c:url value="/resources/library-vendor/html5shiv/html5shiv.js" />" type="text/javascript">
        </script>

        <!-- Google Code Prettify -->
        <script src="<c:url value="/resources/library-vendor/google-code-prettify/prettify.js" />
        " type="text/javascript"></script>

        <!-- jqTree  -->
        <script src="<c:url value="/resources/library-vendor/jqTree-master/tree.jquery.js" />"  type="text/javascript" >
        </script>

        <!-- Cookie Jquery  -->
        <script src="<c:url value="/resources/library-vendor/jquery-cookie-master/jquery.cookie.js" />
        "  type="text/javascript" ></script>

        <!-- Pnotify - pinesframework  -->
        <script src="<c:url value="/resources/library-vendor/pnotify/pnotify.custom.min.js" />
        "  type="text/javascript" ></script>
        ...
        <!-- App -->
        <script src="<c:url value="/resources/app/js/categories/app.categories.js" />"  type="text/javascript" >
        </script>
